...
const SessionConfigPopup = ({ 
  ...
  const handleModeSelect = (selectedMode) => {
    if (selectedMode === 'individual') {
      ...
      router.push(`/pages/FTB-1?sessionID=individual1`);
      handleClose();
    } else {
      ...
      const sharingURL = `${window.location.origin}/pages/FTB-1?sessionID=${newSessionID}`;
  ...
  const handleStart = () => {
    router.push(`/pages/FTB-1?sessionID=${sessionID}`);
    handleClose();
  };
            ...
            <Box sx={{ 
              ...
              <Box sx={{ flex: 1, minWidth: 0 }}>
                ...
                <Typography variant="body1" sx={{ 
                  ...
                  {`${window.location.origin}/pages/FTB-1?sessionID=${sessionID}`}
                </Typography>
                <Button 
                  variant="contained"
