...
const SessionConfigPopup = ({ 
  ...
  const handleModeSelect = (selectedMode) => {
    if (selectedMode === 'individual') {
      ...
      router.push(`/RandomizeActivityVariables?selectedGroup=individual1`);
      handleClose();
    } else {
      ...
      const sharingURL = `${window.location.origin}/RandomizeActivityVariables?selectedGroup=${selectedGroup}`;
  ...
  const handleStart = () => {
    router.push(`/RandomizeActivityVariables?selectedGroup=${selectedGroup}`);
    handleClose();
  };
            ...
            <Box sx={{ 
              ...
              <Box sx={{ flex: 1, minWidth: 0 }}>
                ...
                <Typography variant="body1" sx={{ 
                  ...
                  {`${window.location.origin}/RandomizeActivityVariables?selectedGroup=${selectedGroup}`}
                </Typography>
                <Button 
                  variant="contained"
