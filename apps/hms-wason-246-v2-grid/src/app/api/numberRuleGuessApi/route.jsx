...
export async function POST(request) {
  const { guessID, guessList, finalGuess, actualAnswer, isCorrect, sessionID } = await request.json();
  await connectMongoDB();
  await NumberRuleGuess.create({ guessID, guessList, finalGuess, actualAnswer, isCorrect, sessionID });
