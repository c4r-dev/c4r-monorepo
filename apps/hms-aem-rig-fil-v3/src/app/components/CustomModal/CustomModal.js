      ...
      >
        <Box sx={style}>
          ...
          <Typography id="modal-modal-title" variant="h6" component="h2" sx={{ mb: 2 }}>
            Draw a diagram to explain the correlation between ice cream consumption and Polio cases.
          </Typography>
          <Typography id="modal-modal-title" variant="h6" component="h2" sx={{ mb: 2, ml: 2 }}>
          &#x2022; click and drag between variables to <strong>create a directed edge</strong>
          </Typography>
          <Typography id="modal-modal-title" variant="h6" component="h2" sx={{ mb: 2, ml: 2 }}>
          &#x2022; select a variable or edge and click Delete to <strong>remove it</strong>
          </Typography>
