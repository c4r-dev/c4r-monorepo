    ...
    <div>
      ...
      >
        <Box sx={style}>
            ...
            <Typography id="modal-description" variant="h6" sx={{ mt: 2, textAlign: 'center' }}>
                Read the provided study details and identify as many ways the mask could fail as possible.
            </Typography>
            <Typography id="modal-description" variant="h6" sx={{ mt: 2, mb: 2, textAlign: 'center' }}>
                Click the Hint button if you get stuck!
            </Typography>
