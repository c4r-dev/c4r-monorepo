      ...
      >
        <Box sx={style}>
          ...
          <Typography
            ...
            sx={{ mb: 2 }}
          >
            Use the provided questions to help you draft alternative hypotheses
          ...
          <Typography
            ...
            sx={{ mb: 2 }}
          >
            Remember, an alternative hypothesis (H2) is a different hypothesis
            that, if true, would mean that your original hypothesis (H1), is
            false.
          </Typography>
          <Typography
            id="modal-modal-title"
          ...
          >
            ...
            <br />
            {hypothesis} */}
            {/* <b>Hypothesis 1: </b> Tornadoes are more destructive over time
            because of climate change
            <br />
            <b>Hypothesis 2:</b> Tornadoes are less destructive over time
            because of better warning systems and building codes{" "} */}
          </Typography>
