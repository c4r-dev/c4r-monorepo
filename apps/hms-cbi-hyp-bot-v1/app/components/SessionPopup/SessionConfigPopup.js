...
const SessionConfigPopup = ({ 
  ...
  const handleModeSelect = (selectedMode) => {
    if (selectedMode === 'individual') {
      ...
      router.push(`/Hypothesis?sessionId=individual1&selectedGroup=${selectedGroup}`);
      handleClose();
    } else {
  ...
  const handleStart = () => {
    router.push(`/Hypothesis?sessionId=${sessionID}&selectedGroup=${selectedGroup}`);
    handleClose();
  };
            ...
            <Box sx={{ 
              ...
              <Box sx={{ flex: 1, minWidth: 0 }}>
                ...
                <Typography variant="body1" sx={{ 
                  ...
                  {`${window.location.origin}/Hypothesis?sessionId=${sessionID}&selectedGroup=${selectedGroup}`}
                </Typography>
                <Button 
                  variant="contained"
