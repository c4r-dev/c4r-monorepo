...
export async function POST(request) {
    const { flow, groupId, userId, userName, description } =
        await request.json();
...
export async function GET() {
    try {
        ...
        // console.log("labGroupId from GET", labGroupId);

        // Results for a specific lab group
        // const fludagData = await FluDag.find({ groupId: labGroupId });
