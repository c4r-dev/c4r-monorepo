      ...
      >
        <Box sx={style}>
          ...
          <Typography
            ...
            sx={{ mb: 2 }}
          >
            Each lab member will analyze one variable to identify potential
            relationships with treatment choice and survival outcome.
            <br />
            Your task:
            <br />
            1. Be assigned one demographic variable to investigate
            <br />
            2. Examine its relationship with treatment selection
            <br />
            3. Examine its relationship with survival outcomes
            <br />
            4. Share findings with your lab
          </Typography>
        </Box>
      </Modal>
    </div>
