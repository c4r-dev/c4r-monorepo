...
export default function ShowQRCode() {
  ...
  function generateUniqueLink() {
    return `https://smi-ran-why-ran-v3.vercel.app/RandomizeActivityVariables?selectedGroup=${groupId}`
  }
  function generateUniqueInstructorLink() {
    return `https://smi-ran-why-ran-v3.vercel.app/discussion?selectedGroup=${groupId}`
  }
  ...
  function UseQRCode() {
    ...
    return (
      <SVG
        text={`https://smi-ran-why-ran-v3.vercel.app/RandomizeActivityVariables?selectedGroup=${groupId}`}
        options={{
          margin: 2,
          width: 200,
          color: {
  ...
  return (
    <div className="outer-container">
      ...
      <div className="container qr-code-page">
        <div className="header-container">
          {/* <h1>Join the group exploring the data</h1> */}
          <h3 className='qr-code-text-heading'>As a Participant</h3>
        </div>
        <div></div>
        <br />
        <div className="link-container">
