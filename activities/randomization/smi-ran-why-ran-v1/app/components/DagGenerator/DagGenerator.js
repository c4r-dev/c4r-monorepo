...
export default function DagGenerator({
    ...
    // Handle case where labelA is "Treatment Type" and labelB is "Survival in Days" - Use solid line with arrowhead
    // TODO: Replace hardcoding with a more general solution for edge styling
    if (labelA === "Treatment Type" && labelB === "Survival in Days") {
