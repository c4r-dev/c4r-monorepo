...
function ResultsMultipleLabs() {
  ...
  const [selectedVariableValue, setSelectedVariableValue] = useState('Age')
  ...
  useEffect(() => {
    const fetchData = async () => {
      // setLoading(true)
      try {
        const response = await fetch('https://smi-ran-why-ran-v1.vercel.app/api/groups') // Adjust the endpoint as needed
