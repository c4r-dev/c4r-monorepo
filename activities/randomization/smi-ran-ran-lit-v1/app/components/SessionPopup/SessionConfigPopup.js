...
//       router.push(`/Selection?sessionID=individual1`);
//       handleClose();
//     } else {
...
//   const handleStart = () => {
//     router.push(`/Selection?sessionID=${sessionID}`);
//     handleClose();
//   };

//   const handleCopyLink = async () => {
//     try {
//       const sharingURL = `${window.location.origin}/Selection?sessionID=${sessionID}`;
...
const SessionConfigPopup = ({ 
  ...
  const handleModeSelect = (selectedMode) => {
    if (selectedMode === 'individual') {
      ...
      const sharingURL = `${window.location.origin}/Selection?sessionID=${newSessionID}`;
