...
function RandomizeActivityVariables(props) {
  ...
  const handleSpin = async (grp_id) => {
    const response = await fetch('https://smi-ran-why-ran-v2.vercel.app/api/firstUsers', {
      method: 'POST',
      headers: {
  ...
  const selectRandomVariable = (msg, v = 0) => {
    if (
      ...
      if (v < 4) {
        ...
        setSelectedVariable(variables[v % 4].variableName)
      }
    } else {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Spin the wheel to find what variable are you going to explore.
                </b>
                <Button
                  text={'SPIN VARIABLES'}
                  style={{
