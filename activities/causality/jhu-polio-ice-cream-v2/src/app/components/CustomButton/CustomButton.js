...
export default function CustomButton({
    ...
    const variantClasses = {
        primary: "bg-gray-800 text-white hover:bg-brand-primary active:bg-purple-800 focus:ring-brand-primary disabled:bg-gray-400 disabled:text-gray-600",
        grey: "bg-gray-600 text-white hover:bg-gray-700 focus:ring-gray-500 disabled:bg-gray-700 disabled:text-gray-500", 
        blue: "bg-brand-primary text-white hover:bg-brand-primary-hover focus:ring-brand-primary disabled:bg-gray-700 disabled:text-gray-500",
