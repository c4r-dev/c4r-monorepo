      ...
      >
        <Box sx={style}>
          ...
          <Typography
            ...
            sx={{ mb: 2 }}
          >
            For this activity, consider this experiment: Participants are shown
            a series of negative and positive pictures of people and animals
            while undergoing an fMRI scan. 
          ...
          <Typography
            ...
            sx={{ mb: 2 }}
          >
            Each picture is shown in a block of
            similarly positive or negative pictures, and the order of positive
            and negative blocks of pictures is alternated between subjects.
          </Typography>
          <Typography
            id="modal-modal-title"
            variant="h6"
            ...
            sx={{ mb: 2 }}
          >
            Researchers seek to understand how responses to emotional stimuli
            correlate with activity in the brain, represented by changes in
            blood oxygenation level. Use this information to decide which choice
            is more likely to cause a false positive.
          </Typography>
