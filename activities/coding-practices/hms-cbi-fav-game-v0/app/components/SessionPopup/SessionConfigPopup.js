...
const SessionConfigPopup = ({ 
  ...
  const handleModeSelect = (selectedMode) => {
    if (selectedMode === 'individual') {
      ...
      router.push(`/Selection?sessionId=individual1&round=1`);
      handleClose();
    } else {
      ...
      const sharingURL = `${window.location.origin}/Selection?sessionId=${sessionID}&round=1`;
  ...
  const handleStart = () => {
    router.push(`/Selection?sessionId=${sessionID}&round=1`);
    handleClose();
  };
            ...
            <Box sx={{ 
              ...
              <Box sx={{ flex: 1, minWidth: 0 }}>
                ...
                <Typography variant="body1" sx={{ 
                  ...
                  {`${window.location.origin}/Selection?sessionId=${sessionID}&round=1`}
                </Typography>
                <Button 
                  variant="contained"
