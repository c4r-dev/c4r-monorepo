    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          <Typography id="modal-modal-title" variant="h6" component="h2" sx={{ mb: 2, textAlign: 'center', textWrap: 'auto' }}>
            Click the center of the bias to draw a line to the center of another bias.
          </Typography>
          <Typography id="modal-modal-title" variant="h6" component="h2" sx={{ mb: 2, textAlign: 'center' }}>
          Click the edges of a bias to move it around on your map.
          </Typography>
          <Typography id="modal-modal-title" variant="h6" component="h2" sx={{ mb: 2, textAlign: 'center' }}>
          Once you&apos;ve drawn a line, click it to add a connection.
          </Typography>
