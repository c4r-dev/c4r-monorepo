               ...
               <h1>HOW MANY NUMBER SEQUENCES DID YOU TEST?</h1> 
                <div className="info-content">
                    <div className="info-text">
                        <p>These graphs map your guesses that matched or did not match the rule. You can see your guesses plotted (in purple) against those of others in this session (in blue).</p>
                    </div>
                    <div className="info-text">
